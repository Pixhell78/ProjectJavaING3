...
--
-- Hôte : 127.0.0.1:3306
-- Généré le :  ven. 05 juin 2020 à 12:46
...
(2, 24, 'Mardi', 10, 12, 1, 4, 4),
(3, 25, 'Lundi', 8, 10, 1, 1, 3),
(4, 23, 'Mercredi', 8, 10, 1, 1, 3),
(5, 24, 'Mercredi', 13, 15, 1, 3, 4),
(6, 24, 'Jeudi', 17, 19, 1, 4, 2);
...
(1, 'hugo.vandenbossche@edu.ece.fr', '12345', 'VANDENBOSSCHE', 'Hugo', 4),
(2, 'segado@ece.fr', '12345', 'SEGADO', 'Jean-pierre', 3),
(3, 'hina@ece.fr', '12345', 'HINA', 'Manolo', 3),
(4, 'coudray@ece.fr', '12345', 'COUDRAY', 'Fabienne', 3),
(5, 'lecor@ece.fr', '12345', 'LE COR', 'Luc', 3);
COMMIT;
